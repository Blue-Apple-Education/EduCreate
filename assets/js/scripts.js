jQuery(document).ready(function ($) {
  ...
  // $(".menu-primary-menu-container ul.menu li.level-0 a").hover(function () {
  //   $(this).child("ul.sub-menu").toggleClass("open");
  // });

  // // Parent Level Sub Menu Drop Down
  // $(".menu-primary-menu-container ul.menu li.level-0").hover(function () {
  //   // OPEN at time of click
  //   if ($(this).is(".open")) {
  //     // Close sub-menu
  //     // $(".level-0 .sub-menu").slideUp(500);
  //     $(this).parent("ul.sub-menu").addClass("closed");
  ...
  //     // Open sub-menu
  //     $(this).parent("ul.sub-menu").addClass("open");
