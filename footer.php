<?php
   ...
   FOOTER COLOURS
    ...
    $main_text_colour = get_sub_field('main_text_colour');
    if ($main_text_colour == '') {
        $main_text_colour = '#ffffff';
    }

    $main_section_bg_colour = get_sub_field('main_section_bg_colour');
    if ($main_section_bg_colour == '') {
        $main_section_bg_colour = '#315d98';
    }

    $copyright_section_bg_colour = get_sub_field('copyright_section_bg_colour');
    if ($copyright_section_bg_colour == '') {
        $copyright_section_bg_colour = '#2a4f80';
    }

    $copyright_text_colour = get_sub_field('copyright_text_colour');
    if ($copyright_text_colour == '') {
        $copyright_text_colour = '#5f83b4';
    }

    $copyright_text_hover_colour = get_sub_field('copyright_text_hover_colour');
