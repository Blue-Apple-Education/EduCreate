...
class uikit_top_w_menu extends Walker_Nav_Menu
{
    ...
    public static function fallback($args)
    {
        if (current_user_can('manage_options')) {
            ...
            $fb_output .= '>';
            $fb_output .= '<li><a href="' . admin_url('nav-menus.php') . '">' . __('Add a menu', 'EduCreate') . '</a></li>';
            $fb_output .= '</ul>';
...
{ ?>
<nav class="uk-navbar-container <?php echo 'uk-navbar-transparent'; ?>" uk-navbar>
...
/**
 * Class Name: educreate_offcanvas_menu Output
 * Description: A custom WordPress nav walker class to implement UIkit menu markup
 */
class educreate_offcanvas_menu extends Walker_Nav_Menu
{
 ...
 * Top menu
 */
function uikit_off_canvas_menu()
{ ?>
    ...
    <div class="uk-offcanvas-bar">
        <?php wp_nav_menu(
                array(
                    ...
                    'fallback_cb'       => 'educreate_offcanvas_menu::fallback',
                    'walker'            => new educreate_offcanvas_menu()
                )
            ); ?>
    </div>
</div>
<?php }
add_action('uikit_off_canvas_menu', 'uikit_off_canvas_menu'); ?>