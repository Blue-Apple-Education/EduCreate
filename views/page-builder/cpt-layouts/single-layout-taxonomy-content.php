<?php
        ...
        $choose_category = $storeTax;
        $number_of_posts = 4;
        $tile = 2;

	echo '<div class="flexible-content-wrap row-layout-two-columns single-post clearfix">';

		echo '<div class="flex-two-column-wrap single-post clearfix">';
			echo '<div class="flex-column side-bar viewport_check viewport_check_slideInRight">';
				include(get_stylesheet_directory() . "/template-parts/layouts/single-post-sidebar.php");
			echo '</div>';
			echo '<div class="flex-column main-bar viewport_check viewport_check-left">';

				echo '<section class="flexible-content row-newsfeed-pg-02 archive row-index-2">';
					echo '<div class="container">';

						$query = new WP_Query( array(
							'cpt_tax_newsfeed_categories' => $storeTax,
							'post_status' => 'publish',
							'posts_per_page' => '4',
							'paged' => 1,
							'order' => 'ASC'
    ...
    jQuery(function($) {
        $('body').on('click', '.loadmore', function() {
            ...
            var data = {
                ...
                'tile': <?php echo $tile; ?>,
                'taxonomy': '<?php echo $choose_category; ?>',
