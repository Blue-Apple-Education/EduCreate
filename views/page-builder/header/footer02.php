<?php
    ...
    $trust_info = get_field('trust_info', 'option');
    $footer_trust_logo = $trust_info['footer_trust_logo'];
    $footer_trust_logo_link = $trust_info['footer_trust_logo_link'];
    $footer_trust_text = $trust_info['footer_trust_text'];
...
<footer class="footer02">
    <div class="container">
        ...
        <div class="slide">
            ...
            <span class="trust-title"><?php echo $footer_trust_text; ?></span>
            <a title="Trust link" target="_blank" class="trust logo" href="<?php echo $footer_trust_logo_link['url']; ?>" >
                <img class="trust-logo light" src="<?php echo $footer_trust_logo['url'] ?>" alt="Trust logo">
            </a>
        </div>
