<?php
    ...
    $secondary_logo_light = get_field('secondary_logo_light', 'option');
    $secondar_logo_dark = get_field('secondar_logo_dark', 'option');
...
<header class="<?php echo $getHeader; ?> <?php echo $screen_size; ?>">
    ...
    <div class="centerPage clearfix">
        ...
        <div class="logo-outer-wrap center-logo over-ride viewport_check viewport_check-down">
            <a  target="_blank" href="<?php echo $secondary_link['url']; ?>" class="link"></a>
                <div class="logo-inner-wrap">
                    <img class="light" src="<?php echo $secondary_logo_light['url']; ?>" alt="<?php echo get_bloginfo( 'name' ); ?> logo">
                    <img class="dark" src="<?php echo $secondar_logo_dark['url']; ?>" alt="<?php echo get_bloginfo( 'name' ); ?> logo">
                </div>
            </a>
        </div>
